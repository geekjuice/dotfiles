...
declare -A OUTPUTS=(
  ...
  ["lazydocker.yml"]="$MACOS_DIR/jesseduffield/lazydocker/config.yml"
  ["lazygit.yml"]="$MACOS_DIR/jesseduffield/lazygit/config.yml"
  ["lazynpm.yml"]="$MACOS_DIR/jesseduffield/lazynpm/config.yml"
)
